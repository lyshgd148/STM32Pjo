...
#define SCL_Clear()	 GPIOA->BRR = GPIO_BRR_BR5
#define SCL_Set()	 GPIOA->BSRR = GPIO_BSRR_BS5

#define SDA_Clear()  GPIOA->BRR = GPIO_BRR_BR7
#define SDA_Set()    GPIOA->BSRR = GPIO_BSRR_BS7

#define RES_Clear()  GPIOA->BRR = GPIO_BRR_BR6
#define RES_Set()    GPIOA->BSRR = GPIO_BSRR_BS6

#define DC_Clear()   GPIOA->BRR = GPIO_BRR_BR4
#define DC_Set()     GPIOA->BSRR = GPIO_BSRR_BS4
